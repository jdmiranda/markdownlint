...
import { getCachedRegex } from "./performance-cache.mjs";
...
export default {
  ...
  "function": function MD013(params, onError) {
    ...
    const longLineRe =
      getCachedRegex(longLineRePrefix + lineLength + longLineRePostfix);
    const longHeadingLineRe =
      getCachedRegex(longLineRePrefix + headingLineLength + longLineRePostfix);
    const longCodeLineRe =
      getCachedRegex(longLineRePrefix + codeLineLength + longLineRePostfix);
